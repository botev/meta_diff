        ...
        let choice_res =
            {
                ...
                loop  {
                    let pos = repeat_pos;
                    if repeat_value.len() >= 0usize { break  }
                    let step_res = parse_NEQ(input, state, pos);
                    match step_res {
                        Matched(newpos, value) => {
                            repeat_pos = newpos;
                            repeat_value.push(value);
                ...
                let choice_res =
                    {
                        ...
                        loop  {
                            ...
                            let step_res = parse_DOUBLE_EQ(input, state, pos);
                            match step_res {
                                Matched(newpos, value) => {
                                    repeat_pos = newpos;
                                    repeat_value.push(value);
                        ...
                        let choice_res =
                            {
                                ...
                                loop  {
                                    let pos = repeat_pos;
                                    if repeat_value.len() >= 2usize { break  }
                                    let step_res =
                                        parse_GRT(input, state, pos);
                                    match step_res {
                                        Matched(newpos, value) => {
                                            repeat_pos = newpos;
                                            repeat_value.push(value);
                                                                                                ...
                                                                                                match *graph_res
                                                                                                    ...
                                                                                                    match variable_table.get(&name)
                                                                                                        ...
                                                                                                        =>
                                                                                                        {
                                                                                                            ...
                                                                                                            newargs.insert(0,
                                                                                                                           *id);
                                                                                                            if graph.is_function_name(func)
                                                                                                               {
